...
public class BlockUtils  implements BlockSolvingUtil, BlockIsoUtil {
    ...
    public void applyBlockPermutation(Grid grid, Cell[] image) {
        ...
        if (horiz) {
            ...
            for (int imageindex = 0; imageindex<3; imageindex++) {
                ...
                for (int c = 0; c < 3; c++) {
                    ...
                    for (int r = 0; r < 9; r++) {
                        ...
                        newGrid.setValue(r + 1, c + 1 + column, grid.getValue(image[imageindex].getrIndex() + r, image[imageindex].getcIndex() + c));
                    }
            ...
            for (int r = 0; r < 3; r++) {
                for (int c = 0; c < 9; c++) {
                    newGrid.setValue(r + 1 + row, c + 1, grid.getValue(image[0].getrIndex() + r, image[0].getcIndex() + c));
                }
            }
            row += 3;
            ...
            for (int r = 0; r < 3; r++) {       //use the 4th cell of image
                for (int c = 0; c < 9; c++) {
                    newGrid.setValue(r + 1 + row, c + 1, grid.getValue(image[3].getrIndex() + r, image[3].getcIndex() + c));
                }
            }
            row += 3;
            ...
            for (int r = 0; r < 3; r++) {       //use the 5th cell of image
                for (int c = 0; c < 9; c++) {
                    newGrid.setValue(r + 1 + row, c + 1, grid.getValue(image[4].getrIndex() + r, image[4].getcIndex() + c));
                }
            }
            row += 3;
        }
